...
function NetworkTicketsCard() {
  ...
  const [selectedTicket, setSelectedTicket] = useState(null); // 🔥 modal için
          ...
          <div className="tickets-list__body">
            {tickets.map((ticket) => (
              <div
                ...
                key={ticket.id}
                onClick={() => handleRowClick(ticket)} // 🔥 satıra tıklama
              >
      ...
      {selectedTicket && (
        <div className="ticket-modal__backdrop" onClick={closeModal}>
          <div
            ...
            onClick={(e) => e.stopPropagation()} // backdrop tıklamasında kapanırken içeriğe tıklamayı engelle
          >
